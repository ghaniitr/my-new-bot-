        ...
        async with self._sqlite_conn.cursor() as cursor:
            ...
            await cursor.execute('''
                CREATE TABLE IF NOT EXISTS products (
                    ...
                    description_ar TEXT,
                    description_en TEXT,
                    type TEXT NOT NULL CHECK(type IN ('pdf', 'zip', 'code', 'account')),
